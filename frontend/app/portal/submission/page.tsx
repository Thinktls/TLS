...
function SubmissionInner() {
  ...
  useEffect(() => {
    ...
    api.get(`/buyer/rounds/${roundId}/my-submission`)
  ...
  if (!roundId) return (
    <BuyerLayout>
      <div style={{ textAlign: "center", paddingTop: "80px" }}>
        ...
        <p style={{ color: "var(--text-4)", marginBottom: "16px", fontSize: "0.88rem" }}>
          No round selected. Go to <Link href="/portal/bid" style={{ color: "#60a5fa" }}>Submit Bid</Link> first.
        </p>
      </div>
    </BuyerLayout>
  );
  ...
  if (!bidFile) return (
    <BuyerLayout>
      <div style={{ textAlign: "center", paddingTop: "80px" }}>
        ...
        <Link href={`/portal/bid?round=${roundId}`} className="btn-brand" style={{ textDecoration: "none" }}>
          Submit a Bid
        </Link>
      </div>
    </BuyerLayout>
  ...
  return (
    <BuyerLayout>
      <div style={{ maxWidth: "1060px" }} className="animate-in">
        ...
        {/* Breadcrumb */}
        <Link href="/portal/bid" style={{ display: "inline-flex", alignItems: "center", gap: "6px", fontSize: "0.78rem", color: "var(--text-4)", textDecoration: "none", marginBottom: "20px" }}>
