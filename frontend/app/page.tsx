...
const FEATURES = [
  ...
  },
  {
    ...
    desc: "Three-tier engine: exact match → fuzzy (RapidFuzz) → Claude AI — automatically resolves part number variants.",
  },
  {
    icon: "🏆",
      ...
      <div style={{ minHeight: "100vh", background: "#0c0c0c", color: "var(--text-1)", fontFamily: "Inter, system-ui, sans-serif", overflowX: "hidden" }}>
        ...
        <nav style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <a href="/login" className="outline-btn" style={{ padding: "10px 24px", fontSize: "0.88rem" }}>
              Sign In →
            </a>
          </div>
        </nav>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "16px" }}>
            {[
              ...
              <div key={s.label} className="stat-card">
                ...
                <div style={{ fontSize: "0.78rem", color: "rgba(255,255,255,0.4)", letterSpacing: "0.01em" }}>
                  {s.label}
                </div>
              </div>
            ))}
        ...
        <section id="features" style={{ position: "relative", zIndex: 1, maxWidth: "1100px", margin: "0 auto 100px", padding: "0 24px" }}>
          ...
          <p style={{ textAlign: "center", color: "rgba(255,255,255,0.4)", marginBottom: "56px", fontSize: "1rem" }}>
        ...
        <section style={{ position: "relative", zIndex: 1, maxWidth: "800px", margin: "0 auto 80px", padding: "0 24px" }}>
          <div style={{
            ...
            <p style={{ color: "rgba(255,255,255,0.45)", marginBottom: "36px", fontSize: "0.95rem" }}>
        ...
        <footer style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <LogoMark size={16} />
            <span style={{ fontSize: "0.82rem", color: "rgba(255,255,255,0.3)", letterSpacing: "-0.01em" }}>
              ThinkTLS Bid Desk
            </span>
          </div>
